...
class DirectoryData {
    ...
    var foundersData: [Int:Founder] = [0:
        Founder(firstName: "Chewbacca", lastName: "Wookiee", fullName: "Chewie Wookiee", preferredName: "Chewie", phone: "801-555-1212", email: "chewie@gmail.com", bio: "Chewbacca, nicknamed \"Chewie\", is a fictional character in the Star Wars franchise. He is a Wookiee, a tall, hirsute biped and intelligent species from the planet Kashyyyk. Chewbacca is the loyal friend and associate of Han Solo, and serves as co-pilot on Solo's ship, the Millenium Falcon.", status: "Gold", year: "1984", address: "125 Sailing Along Now", image: UIImage(named: "founder1")!, spouse: nil),
    ...
    func loadFounders() {
        ...
        for _ in 1...20 {
            founders.append(Int(arc4random_uniform(4)))
        }
